...
import { ArrowRight, Mail, Lock, Wallet } from "lucide-react";
          ...
          <form className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-accent-gold text-xs hover:text-accent-gold-hover cursor-pointer">
                  Forgot password?
                </span>
              </div>
              <div className="relative">
            ...
            <button
              type="submit"
              className="w-full bg-accent-gold hover:bg-accent-gold-hover text-primary-dark font-bold py-3 rounded-lg transition-colors flex items-center justify-center gap-2 mt-2"
            >
